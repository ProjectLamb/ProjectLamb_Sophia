...
*
    ...
    public class Projectile : MonoBehaviour {
        ...
        private void OnTriggerEnter(Collider other) {
            ...
            affectableEntity.AsyncAffectHandler(new PoisonState(damagebleEntity).AsyncAffectorCoroutine);
        }
    }
    ```
...
affectableEntity.AsyncAffectHandler(poison.AsyncAffectorCoroutine);
```

...
public class FractalNoise
{
		...
		: this (inH, inLacunarity, inOctaves, null)
	{
		...
		public FractalNoise (float inH, float inLacunarity, float inOctaves, PerlinGILUMINA noise)
	{
	...
	private PerlinGILUMINA m_Noise;

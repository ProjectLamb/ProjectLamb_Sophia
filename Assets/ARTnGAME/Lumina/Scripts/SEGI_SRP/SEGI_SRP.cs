...
namespace Artngame.LUMINA
{
    ...
    public class SEGI_SRP : MonoBehaviour
    {
        //v0.6
        ...
        void Init()
        {
            ...
            if (!material)
            {
                material = new Material(Shader.Find("Hidden/SEGI_SRP"));
        ...
        void OnRenderImage(RenderTexture source, RenderTexture destination)
        {
            ...
            if (visualizeNORMALS)
            {
                Graphics.Blit(currentNormal, destination);
                return;
            }
            if (visualizeDEPTH)
            {
                Graphics.Blit(currentDepth, destination);
                return;
            }

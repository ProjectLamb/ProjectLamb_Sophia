...
//      protected   Rigidbody           carrierRigidBody    = null;
        ...
        //  TryGetComponent<Rigidbody>(out carrierRigidBody);
            base.Awake();
            triggerAffectors = triggerAffectors ?? new List<EntityAffector>();
        }
        ...
        protected virtual void OnTriggerEnter(Collider _other) {
            ...
            if(CheckIsOwnerCollider(_other)) {
                ConveyAffectorToTarget(ownerEntity);
            }
        }
        ...
        protected void ConveyAffectorToTarget(Entity _targetEntity){
            ownerEntity.GetFinalData().ProjectileShootState?.Invoke(ownerEntity, _targetEntity);
            triggerAffectors.ForEach(Affector => Affector.Init(ownerEntity, _targetEntity).Modifiy());
        }
    }
}
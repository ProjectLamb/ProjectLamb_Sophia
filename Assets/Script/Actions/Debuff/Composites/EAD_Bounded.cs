...
/// </param>
/// <returns></returns>
public class EAD_BoundedState : EntityAffector
{
    ...
    public EAD_BoundedState(GameObject _owner, GameObject _target, object[] _params) : base(_owner, _target, _params)
    {
    ...
    {
        mPlayerData.attributeData.mDebuffState[(int)E_DebuffState.Bounded]++;

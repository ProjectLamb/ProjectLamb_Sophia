...
/// </param>
/// <returns></returns>
public class EAD_BleedState : EntityAffector
{
    ...
    public EAD_BleedState(GameObject _owner, GameObject _target, object[] _params) : base(_owner, _target, _params)
    {
    ...
    {
        mPlayerData.attributeData.mDebuffState[(int)E_DebuffState.Bleed]++;

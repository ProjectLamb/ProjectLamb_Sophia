...
///       > Pipeline = EnityData      +*  addingData; <br/>
///       > Pipeline = PlayerData     +*  addingData; <br/>
///       > Pipeline = WeaponData     +*  addingData; <br/>
///       > Pipeline = SkillData      +*  addingData; <br/>
///       > Pipeline = AddingData   +*  addingData; <br/>
/// 특징 : 파이프라인은 어떤 데이터와도 치환 가능하다.  <br/>
///     >  addingData.PipeToEntity(ref EntityData _data); <br/>
///     >  addingData.PipeToPlayer(ref PlayerData _data); <br/>
///     >  addingData.PipeToSkill(ref SkillData _data); <br/>
///     >  addingData.PipeToWeapon(ref WeaponData _data); <br/>
/// </summary>
...
public class AddingData {    
    ...
    public static AddingData operator +(AddingData x, EntityData y)
    {
        AddingData res = new AddingData();
    ...
    public static AddingData operator +(AddingData x, PlayerData y)
    {
        AddingData res = new AddingData();
        res.MaxHP = x.MaxHP +y.MaxHP;
        res.CurHP = x.CurHP +y.CurHP;
    ...
    public static AddingData operator +(AddingData x, WeaponData y)
    {
        AddingData res = new AddingData();
    ...
    public static AddingData operator +(AddingData x, SkillData y){
        AddingData res = new AddingData();
        for(int i = 0; i < 3; i++){
            for(int j =0; j < 3; j++){
    ...
    public static AddingData operator +(EntityData x, AddingData y)
    {
        AddingData res = new AddingData();
        res.MaxHP = x.MaxHP +y.MaxHP;
        res.CurHP = x.CurHP +y.CurHP;
    ...
    public static AddingData operator +(PlayerData y, AddingData x)
    {
        AddingData res = new AddingData();
        res.MaxHP = x.MaxHP +y.MaxHP;
        res.CurHP = x.CurHP +y.CurHP;
    ...
    public static AddingData operator +(WeaponData y, AddingData x)
    {
        AddingData res = new AddingData();
        res.DamageRatio     = x.DamageRatio + y.DamageRatio;
        res.WeaponDelay     = x.WeaponDelay + y.WeaponDelay;
    ...
    public static AddingData operator +(SkillData y, AddingData x){
        AddingData res = new AddingData();
        for(int i = 0; i < 3; i++){
            for(int j =0; j < 3; j++){
                res.SkillInfos[i].numericArray[j]   = x.SkillInfos[i].numericArray[j] + y.SkillInfos[i].numericArray[j];
    ...
    public static AddingData operator *(EntityData y, AddingData x)
    {
        AddingData res = new AddingData();
        res.MaxHP = x.MaxHP *y.MaxHP;
        res.CurHP = x.CurHP *y.CurHP;
    ...
    public static AddingData operator /(AddingData x, PlayerData y)
    {
        ...
        res.StaminaRestoreRatio = x.StaminaRestoreRatio / ((y.StaminaRestoreRatio < 0.001f) ? 1 : y.StaminaRestoreRatio);
    ...
    public static AddingData operator +(AddingData x, AddingData y){
        AddingData res = new AddingData();
        res.MaxHP       = x.MaxHP       + y.MaxHP;
        res.CurHP       = x.CurHP       + y.CurHP;
        res.MoveSpeed   = x.MoveSpeed   + y.MoveSpeed;
